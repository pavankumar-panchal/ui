                                                ...
                                                <form action="" method="post" name="submitform" id="submitform"
                                                    ...
                                                    <div class="display">
                                                        ...
                                                        <table class="table table-bordered table2">
                                                            <tbody>
                                                                <tr class="bg-white">
                                                                    <td valign="top">Support Units:</td>
                                                                    <td valign="top">
                                                                        <span id="filterprdgroupdisplay">
                                                                            <select name="s_productgroup"
                                                                                class="form-select swiftselect form-control"
                                                                ...
                                                                <tr class="bg-white">
                                                                    ...
                                                                    <td valign="top">
                                                                        <label><input name="stremoteconnection"
                                                                                id="stremoteconnection" type="checkbox"
                                                                                value=""> Remote Connection
                                                                        </label><label><input name="marketingperson"
                                                                                id="marketingperson" type="checkbox"
                                                                                value=""> Marketing Person
                                                                        </label><label><input name="onsitevisit"
                                                                                id="onsitevisit" type="checkbox"
                                                                                value=""> Onsite Visit </label><br>
                                                                        <label><input name="overphone" id="overphone"
                                                                                type="checkbox" value=""> Over Phone
                                                                        </label><label><input name="mail" id="mail"
                                                                                type="checkbox" value=""> Mail </label>
