                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="productgroup" id="productgroup" class="form-control form-select">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="errordescription" type="text" class="form-control" id="errordescription"
                                size="30" autocomplete="off" value="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="enteredby" id="enteredby" class="form-control form-select">
                                <option value="">Make A Selection</option>
                                <!-- Other options -->
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input name="reportedby" type="text" class="form-control" id="reportedby" size="30"
                                autocomplete="off" value="">
                        </div>
                    </div>
                </div>
