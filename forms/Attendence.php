    ...
    <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="../#">
                ...
                <ul class="nav-group-items">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../forms/email.html"><span class="nav-icon"></span>
                            Emails</a></li>
                    <li class="nav-item"><a class="nav-link" href="../forms/error_register.html"><span class="nav-icon"></span> Errors</a></li>
                    <li class="nav-item"><a class="nav-link" href="../forms/In-house.html"><span class="nav-icon"></span> In-house</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="../forms/Onsite_register.html"><span class="nav-icon"></span> Onsite</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="../forms/References.html"><span class="nav-icon"></span> References</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="../forms/Requirements.html"><span class="nav-icon"></span> Requirements</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="../forms/skype.html"><span class="nav-icon"></span>
                            Skype</a></li>
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="../#">
                ...
                <ul class="nav-group-items">
                    <li class="nav-item"><a class="nav-link" href="../forms/invoices.html"><span class="nav-icon"></span>
                            Invoices</a></li>
                    <li class="nav-item"><a class="nav-link" href="../forms/receipts.html"><span class="nav-icon"></span>
                            Receipts</a></li>
            ...
            <li class="nav-group"><a class="nav-link nav-group-toggle" href="../#">
                ...
                <ul class="nav-group-items">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../forms/Categories.html"> Categories</a></li>
                    <li class="nav-item"><a class="nav-link" href="../forms/support.html"> Support Units</a></li>
                    <li class="nav-item"><a class="nav-link" href="../forms/Non-working_days.html"> Non Working Days</a></li>
                </ul>
            </li>
