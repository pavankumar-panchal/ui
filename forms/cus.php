                            ...
                            <td><span style="display:none" id="short_url"></span>
                                <table class="table table-bordered">
                                    <tbody>
                                            ...
                                            <td colspan="2" valign="top" style="padding:0px">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                <td class="bg-light" width="20%"> Business
                                                                    Name[Company]:</td>
                                                                <td class="bg-light" width="80%"> <input name="address"
                                                                        type="text" class="form-control" id="address"
                                                                        maxlength="200" autocomplete="off"> </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            ...
                                            <td colspan="2" valign="top" style="padding:0px">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                <td class="bg-light" width="20%"> Address:</td>
                                                                <td class="bg-light" width="80%"> <input name="address"
                                                                        type="text" class="form-control" id="address"
                                                                        maxlength="200" autocomplete="off"> </td>
                                                            </tr>
                                        ...
                                        <tr>
                                            <td width="51%" valign="top" style="border-right:1px solid #d1dceb;">
                                                <div class=" table table-responsive">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                <td class="bg-light">Place:</td>
                                                                <td class="bg-light"> <input name="place" type="text"
                                                                        class="form-control" id="place" maxlength="100"
                                                                        autocomplete="off"> </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="bg-light">State:</td>
                                                                <td class="bg-light"> <select name="state"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bg-light" id="districtcodedisplay"> <select
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bg-light" id="districtcodedisplay"> <input
                                                                        name="place" type="text" class="form-control"
                                                                        id="place" maxlength="100" autocomplete="off">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="bg-light"> <textarea name="remarks" cols="27"
                                            ...
                                            <td width="50%" class="">
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="bg-light"> <input name="contactperson"
                                                                        type="text" class="form-control"
                                                                        id="contactperson" maxlength="100"
                                                                        autocomplete="off"> </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="bg-light">Last Password: </td>
                                                                <td class="bg-light"> <input name="contactperson"
                                                                        type="text" class="form-control"
                                                                        id="contactperson" maxlength="100"
                                                                        autocomplete="off"> </td>
                                                            ...
                                                            <tr>
                                                                <td class="bg-light">Current Dealer: </td>
                                                                <td class="bg-light"> <input name="contactperson"
                                                                        type="text" class="form-control"
                                                                        id="contactperson" maxlength="100"
                                                                        autocomplete="off"> </td>
                                                            ...
                                                            <tr>
                                                                <td class="bg-light">Company Closed: </td>
                                                                <td class="bg-light">
                                                                    <div class="form-check"> <input
                                                                            class="form-check-input" type="checkbox"
                                                                            name="servicecharge" id="servicecharge"
                                                                            onclick="enableoutstandingbills();"> </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="bg-light">Promotional SMS:</td>
                                                                <td class="bg-light">
                                                                    <div class="form-check"> <input
                                                                            class="form-check-input" type="checkbox"
                                                                            name="servicecharge" id="servicecharge"
                                                            ...
                                                            <tr>
                                                                <td class="bg-light">Promotional Email:</td>
                                                                <td class="bg-light">
                                                                    <div class="form-check"> <input
                                                                            class="form-check-input" type="checkbox"
                                                                            name="servicecharge" id="servicecharge"
                                                            ...
                                                            <div class="container mt">
                                                                <table class="table table-bordered table-border-grid">
                                                                    <tbody>
                                                                        <tr class="table-primary">
                                                                            ...
                                                                            <td width="29%" align="center">
                                                                                <strong>Regn</strong> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td class="bg-light"> <strong>TDS</strong>
                                                                            </td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="bg-light"> <strong>STO</strong>
                                                                            </td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="bg-light"> <strong>SPP</strong>
                                                                            </td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="bg-light"> <strong>GST</strong>
                                                                            </td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                        ...
                                                                        <tr>
                                                                            <td class="bg-light"> <strong>SAC</strong>
                                                                            </td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                                            <td class="bg-light"> &nbsp;</td>
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="text-end"> <input name="view" type="submit"
...
<div class="container mt-4 p-4 rounded-2" style="box-shadow: 1px 1px 2px 1px rgba(0, 0, 0, 0.363); width: 98%;">
    <table class="table table-bordered">
        ...
        <tbody id="adddescriptionrows">
            <tr>
                ...
                <td> <input name="emailid1" type="text" class="form-control" maxlength="200" autocomplete="off"> </td>
                <td>
    ...
    <div class="text-end mt-2"> <a onclick="adddescriptionrows();" style="cursor:pointer" class="r-text">Add one More
            >></a> </div>
