                    ...
                    <div class="col-md-6">
                        <form action="" method="post" name="submitform" id="submitform" onsubmit="return false;">
                            <div class="display">
                                ...
                                <div class="mb-3">
                                    <label for="registered-name" class="form-label">Sender ID:</label>
                                    <input name="customername" type="text" class="form-control" id="customername"
                                        autocomplete="off">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="state" class="form-label">Skype Conversation:</label>
                                    <input name="customername" type="text" class="form-control" id="customername"
                                        autocomplete="off">
                                </div>
                                <div class="mb-3">
                                    <label for="caller-type" class="form-label">Attachment:</label>
                                    <input name="customername" type="file" class="form-control" id="customername"
                                        autocomplete="off">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="registered-name" class="form-label">Entered ID:</label>
                                    <input name="customername" type="text" class="form-control" id="customername"
                                        autocomplete="off">
                                </div>
                                <div class="mb-3">
                                    <label for="registered-name" class="form-label">skype ID:</label>
                                    <input name="customername" type="text" class="form-control" id="customername"
                                        autocomplete="off">
                                </div>
