                            ...
                            <div class="display">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="anonymous" type="radio" name="anonymous" id="databasefield12"
                                            value="yes" onclick="formsubmitcustomer();">
                                        <label class="form-check-label" for="databasefield12">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="anonymous" type="radio" name="anonymous" id="databasefield13"
                                            value="no" onclick="formsubmitcustomer();" checked="checked">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="customerid" type="text" class="form-control" id="customerid"
                                        autocomplete="off" size="30" autocomplete="off" readonly="readonly"
                        ...
                        <form action="" method="post" name="submitform" id="submitform" onsubmit="return false;">
                            <div class="display">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="conversation" type="text" class="form-control" id="conversation"
                                        autocomplete="off">
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="categoryblr" id="categoryblr"
                                        value="" checked>
                                    <label class="form-check-label" for="categoryblr">BLR</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="categorycsd" id="categorycsd"
                                        value="" checked>
                                    <label class="form-check-label" for="categorycsd">CSD</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="categorykkg" id="categorykkg"
                                        value="" checked>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="s_customer" id="s_customer"
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="s_employee" id="s_employee"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                <label for="state" class="form-label">Attachment:</label>
                                <input name="fromdate" type="text" class="form-control" id="DPC_fromdate" size="30"
                                    autocomplete="off" value="21-07-2023" datepicker_format="DD-MM-YYYY" maxlength="10"
                                    isdatepicker="true">
                            </div>
                            ...
                            <div class="mb-3">
                                <label for="state" class="form-label">Skype Id:</label>
                                <input name="fromdate" type="text" class="form-control" id="DPC_fromdate" size="30"
