    ...
    <div class="card-body">
      ...
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#basic-example"
              target="_blank">
              <svg class="icon me-2">
    ...
    <div class="card-body">
      ...
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#multiple-inputs"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
    ...
    <div class="card-body">
      ...
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#multiple-addons"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
    ...
    <div class="card-body">
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#button-addons"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
    ...
    <div class="card-body">
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#segmented-buttons"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
      ...
      <div class="card-body">
        <div class="example">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#custom-select"
                target="_blank">
                <svg class="icon me-2">
                  <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                </svg>Code</a></li>
      ...
      <div class="card-body">
        <div class="example">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/input-group/#custom-file-input"
                target="_blank">
                <svg class="icon me-2">
                  <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                </svg>Code</a></li>
