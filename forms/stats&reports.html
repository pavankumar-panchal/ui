      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb my-0 ms-2">
            <li class="breadcrumb-item">triped
              <span>Home</span>
            </li>
                          ...
                          <table class="table table-bordered ">
                            <tbody>
                              ...
                              <tr class="bg-white">
                                ...
                                <td valign="top">
                                  <label><input name="customer" type="checkbox" id="customer" value="Customer"
                                      checked="checked">
                                    Customers</label>
                                  <label><input name="dealer" type="checkbox" id="dealer" value="Dealer"
                                      checked="checked">
                                    Dealers</label>
                                  <label><input name="employee" type="checkbox" id="employee" value="employee"
                                      checked="checked">
                                    Employees</label>
                                  <label><input name="ssmuser" type="checkbox" id="ssmuser" value="SSMUser"
                                      checked="checked">
                                    SSM Users</label>
                                </td>
                              </tr>
                              ...
                              <tr class="bg-white">
                                ...
                                <td valign="top">
                                  <label><input name="reporton" type="radio" id="reporton0" value="statistics"
                                      checked="checked">
                                    Statistics</label>
