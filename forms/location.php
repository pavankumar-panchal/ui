                                ...
                                <form action="" method="post" name="submitform" id="submitform"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 border-right">
                                            <div class="form-group">
                                                ...
                                                <input name="dealername" type="text" class="form-control"
                                                    id="dealername" size="30" isdatepicker="true">
                                            </div>
                                            <div class="form-group">
                                                <label for="dealercompanyname">Business Name:</label>
                                                <input name="dealercompanyname" type="text" class="form-control"
                                                    id="dealercompanyname" size="30" isdatepicker="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="contactnumber" type="text" class="form-control"
                                                    id="contactnumber" size="30" isdatepicker="true">
                                            </div>
                                            <div class="form-group">
                                                <label for="emailid">Place:</label>
                                                <input name="emailid" type="text" class="form-control" id="emailid"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="skypeid" type="text" class="form-control" id="skypeid"
                                                    size="30" isdatepicker="true">
                                            </div>
                                            <div class="form-group">
                                    ...
                                    <div class="text-center mt-3 float-end">
                                        ...
                                        <input name="delete" type="submit" class="btn btn-danger" id="delete"
                                            value="Delete" onclick="formsubmit('delete')">
                                    </div>
                                </form>
                            </div>
                        </div>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <label>
                                                        <input type="radio" name="databasefield" id="databasefield0"
                                                            value="locationname" checked="checked">
                                                        Location Name</label>
                                                ...
                                                <div class="form-check form-check-inline"><label>
                                                        <input type="radio" name="databasefield" value="address"
                                                            id="databasefield2">
                                                        Address</label> </div>
                                                <div class="form-check form-check-inline"><label>
                                                        <input type="radio" name="databasefield" value="place"
                                                            id="databasefield3">
                                                        Place</label> </div>
                                                <div class="form-check form-check-inline"><label>
                                                ...
                                                <div class="form-check form-check-inline"><label>
                                                        ...
                                                        Phone</label> </div>
                                                <div class="form-check form-check-inline"><label>
                                                        <input type="radio" name="databasefield" value="emailid"
                                                            id="databasefield8">
                                                        Email Id</label> </div>
                                                <div class="form-check form-check-inline"><label>
                                                        <input type="radio" name="databasefield"
                                                            value="locationincharge" id="databasefield4">
