    ...
    <div class="card">
      <div class="card-header bg-light " style="cursor:pointer" onclick="showhide('maindiv','toggleimg');">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <img src="../images/minus.jpg" border="0" id="toggleimg" name="toggleimg" class="img-fluid" style="max-height: 20px;" align="absmiddle">
        </div>
      </div>
      <div class="card-body" id="maindiv" style="display: block;">
        <form action="" method="post" name="submitform" id="submitform" onsubmit="return false;">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input name="productversion" type="text" class="form-control swifttext" id="productversion" size="30" isdatepicker="true">
              </div>
              <div class="form-group">
                <label for="releasedate">Release Date:</label>
                <div class="input-group">
                  <input name="releasedate" type="date" class="form-control swifttext" id="DPC_releasedate" size="30"  datepicker_format="DD-MM-YYYY" maxlength="10" isdatepicker="true">
          ...
          <div class="text-center mt-3 float-end">
            ...
            <input name="new" type="reset" class="btn btn-secondary" id="new" value="New" onclick="newentry();clearinnerhtml();">
            <input name="save" type="submit" class="btn btn-primary" users="" id="save" value="Save" onclick="formsubmit('save')">
            <input name="delete" type="submit" class="btn btn-danger" id="delete" value="Delete" onclick="formsubmit('delete')" disabled>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-header bg-light" style="cursor:pointer" onclick="showhide('filterdiv','toggleimg1');">
        <div class="d-flex justify-content-between align-items-center">
          ...
          <img src="../images/minus.jpg" border="0" id="toggleimg1" name="toggleimg1" class="img-fluid" style="max-height: 20px;" align="absmiddle">
        </div>
      </div>
        ...
        <form action="" method="post" name="filterform" id="filterform" onsubmit="return false;">
            ...
            <div class="col-md-6 border-right">
              <div class="form-group">
                ...
                <div id="textname" style="display:block">
                  <input name="searchcriteria" type="text" class="form-control swifttext" id="searchcriteria" size="40" isdatepicker="true">
                </div>
          ...
          <div class="mt-3">
            ...
            <div class="form-check form-check-inline">
              <input type="radio" name="databasefield" id="databasefield0" value="productname" checked="checked" onclick="prdname('textname',databasefield0);" class="form-check-input">
              <label class="form-check-label" for="databasefield0">Product Name</label>
            </div>
            <div class="form-check form-check-inline">
              <input type="radio" name="databasefield" id="databasefield2" value="releasedate" onclick="prdname('textname',databasefield2);" class="form-check-input">
              <label class="form-check-label" for="databasefield2">Release Date</label>
            </div>
            <div class="form-check form-check-inline">
              <input type="radio" name="databasefield" id="databasefield1" value="productgroup" onclick="prdgroup('groupname',databasefield1);" class="form-check-input">
              <label class="form-check-label" for="databasefield1">Product Group</label>
            </div>
          </div>
          <div class="text-center mt-3 float-end">
            <div id="filter-form-error"></div>
            <input name="view" type="submit" class="btn btn-primary swiftchoicebutton" id="view" value="View" onclick="formfilter('view');">
           
            <input name="view" type="submit" class="btn btn-warning swiftchoicebutton" id="view" value="Excel" onclick="formfilter('view');">
