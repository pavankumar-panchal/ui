    ...
    <div class="card-body">
      ...
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/checks-radios/#indeterminate"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
      ...
      <div class="card-body">
        ...
        <div class="example">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/checks-radios/#disabled-1"
                target="_blank">
                <svg class="icon me-2">
                  <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                </svg>Code</a></li>
      ...
      <div class="card-body">
        ...
        <div class="example">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/checks-radios/#default-stacked"
                target="_blank">
                <svg class="icon me-2">
                  <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                </svg>Code</a></li>
        ...
        <div class="example">
          ...
          <div class="tab-content rounded-bottom">
            <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1008">
              <div class="form-check">
                <input class="form-check-input" id="exampleRadios1" type="radio" name="exampleRadios" value="option1"
                  checked="">
              ...
              <div class="form-check">
                <input class="form-check-input" id="exampleRadios3" type="radio" name="exampleRadios" value="option3"
                  disabled="">
      ...
      <div class="card-body">
        ...
        <div class="example">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/checks-radios/#without-labels"
                target="_blank">
                <svg class="icon me-2">
                  <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                </svg>Code</a></li>
      ...
      <div class="card-body">
        ...
        <div class="example">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/checks-radios/#toggle-buttons"
                target="_blank">
                <svg class="icon me-2">
                  <use xlink:href="../vendors/@coreui/icons/svg/free.svg#cil-code"></use>
                </svg>Code</a></li>
  ...
  <div class="col-12">
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        <h3 id="outlined-styles">Outlined styles<a class="anchorjs-link" aria-label="Anchor" data-anchorjs-icon="#"
            href="#outlined-styles" style="padding-left: 0.375em;"></a></h3>
        ...
        <div class="example">
          ...
          <div class="tab-content rounded-bottom">
            <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1016">
              ...
              <input class="btn-check" id="success-outlined" type="radio" name="options-outlined" autocomplete="off"
                checked="">
