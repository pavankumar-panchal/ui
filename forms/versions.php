                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="productversion" type="text" class="form-control swifttext" id="productversion"
                          size="30" isdatepicker="true">
                      </div>
                      <div class="form-group">
                        <label for="releasedate">Release Date:</label>
                        <div class="input-group">
                          <input name="releasedate" type="date" class="form-control swifttext" id="DPC_releasedate"
                            size="30" datepicker_format="DD-MM-YYYY" maxlength="10" isdatepicker="true">
