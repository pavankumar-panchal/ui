                ...
                <ul class="header-nav ms-3">
                    <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="../#"
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            <div class="dropdown-header bg-white py-2">
                                                        ...
                                                        <table class="table table-bordered table1">
                                                            <tbody>
                                                                ...
                                                                <tr class="bg-white">
                                                                    ...
                                                                    <td valign="top">
                                                                        <input name="customerid" type="password"
                                                                            class="form-control" id="customername"
                                                                            size="20" autocomplete="off"
                                                                            isdatepicker="true">
                                                                    </td>
                                                                ...
                                                                <tr class="bg-white">
                                                                    ...
                                                                    <td valign="top">
                                                                        <input name="customerid" type="tel"
                                                                            class="form-control" id="customername"
                                                                            size="20" autocomplete="off"
                                                                            isdatepicker="true">
                                                                    </td>
                              ...
                              <div class="card-body">
                                <form action="" method="post" name="filterform" id="filterform" onsubmit="return false;">
                                    ...
                                    <div class="col-md-12">
                                      <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                          <input type="radio" name="databasefield" id="databasefield0" value="username" checked="checked" class="form-check-input">
                                        ...
                                        <div class="form-check form-check-inline">
                                          <input type="radio" name="databasefield" value="locationname" id="databasefield2" class="form-check-input">
                                          <label class="form-check-label" for="databasefield2">Location Name</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input type="radio" name="databasefield" value="reportingauthority" id="databasefield3" class="form-check-input">
                                          <label class="form-check-label" for="databasefield3">Reporting Authority</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input type="radio" name="databasefield" value="supportunit" id="databasefield4" class="form-check-input">
                                          <label class="form-check-label" for="databasefield4">Support Unit</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                          <input type="radio" name="databasefield" value="existinguser" id="databasefield5" class="form-check-input">
                                  ...
                                  <div class="text-center float-end mt-3">
                                    ...
                                    <input name="excel" type="submit" class="btn btn-warning swiftchoicebutton" id="excel" value="excel" onclick="formfilter('excel');">
