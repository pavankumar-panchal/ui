    ...
    <div class="card-body">
      ...
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/floating-labels/#example"
              target="_blank">
              <svg class="icon me-2">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <p class="text-medium-emphasis small">By default, <code>&lt;textarea&gt;</code>s with
        <code>.form-control</code> will be the same height as <code>&lt;input&gt;</code>s.
      </p>
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/floating-labels/#textareas"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <p class="text-medium-emphasis small">Other than <code>.form-control</code>, floating labels are only
        ...
        state.<strong>Selects with <code>size</code> and <code>multiple</code> are not supported.</strong>
      </p>
      <div class="example">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item"><a class="nav-link" href="https://coreui.io/docs/forms/floating-labels/#selects"
              target="_blank">
              <svg class="icon me-2">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-code"></use>
              </svg>Code</a></li>
