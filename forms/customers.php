                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input name="businessname" type="text" class="form-control"
                                                id="businessName" maxlength="200" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="container mt-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 border-end bg-light py-2">
                                                    <strong>TDS</strong>
                                                </div>
                                                <div class="col-md-3 border-end bg-light py-2">
                                                    &nbsp;
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="input-group"> <input name="detailsearchtext" type="text"
                                                ...
                                                onkeyup="customersearch(event);" autocomplete="off" isdatepicker="true"
                                                placeholder="search.."> <span style="display:none"> <input
                                                    name="searchtextid" type="hidden" id="searchtextid"
                                                    disabled="disabled"> </span> </div>
                                        <div id="detailloadcustomerlist" class="mt-2"> <select name="customerlist"
                                                size="5" class="form-control" id="customerlist"
                                                style="width:100%; height:400px" onclick="selectfromlist();"
                                            ...
                                            <div style="height: 230px; overflow: auto;">
                                                ...
                                                <div style="height:230px; overflow:scroll" align="left">
                                                    <label><input type="checkbox" checked="checked"
                                                            name="productarray[]" id="Accounting Software"
                                                            value="224">&nbsp;Accounting Software
