                            ...
                            <table class="table table-bordered table1">
                              <tbody>
                                ...
                                <tr class="bg-white">
                                  ...
                                  <td valign="top">
                                    <input name="customerid" type="password" class="form-control" id="customername"
                                      size="20" autocomplete="off" isdatepicker="true">
                                  </td>
                                </tr>
                                <tr class="bg-white">
                            ...
                            <table class="table table-bordered table2">
                              <tbody>
                                ...
                                <tr class="bg-white">
                                  ...
                                  <td valign="top">
                                    <input name="customerid" type="email" class="form-control" id="customername"
                                      size="20" autocomplete="off" isdatepicker="true">
                                  </td>
                                </tr>
                                ...
                                <tr class="bg-white">
                                  ...
                                  <td valign="top">
                                    <input name="complaintid" type="date" class="form-control swifttext"
                ...
                <div class="card-body">
                  <form action="" method="post" name="filterform" id="filterform" onsubmit="return false;">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="searchcriteria" type="text" class="form-control swifttext" id="searchcriteria"
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="form-check form-check-inline">
                            <input type="radio" name="databasefield" id="databasefield0" value="username"
                    ...
                    <div class="text-center float-end mt-3">
                      ...
                      <input name="excel" type="submit" class="btn btn-warning swiftchoicebutton" id="excel"
                        value="excel" onclick="formfilter('excel');">
