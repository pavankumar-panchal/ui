...
<body>
    ...
    <div class="wrapper d-flex flex-column min-vh-100 bg-white">
        ...
        <div class="body flex-grow-1 px-3">
                                                ...
                                                <table class="table table-bordered ">
                                                    <tbody>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    <input name="date" type="date" class="form-control"
                                                                        id="DPC_date" datepicker_format="DD-MM-YYYY"
                                                        ...
                                                        <tr>
                                                            <td>Occasion:</td>
                                                            <td>
                                                                <input name="occassion" type="text" class="form-control"
                                                                    id="occassion" size="60 " isdatepicker="true">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Remarks:</td>
                                                            <td>
                                                                <textarea name="remarks" cols="45" class="form-control"
                                                                    id="remarks" data-gramm="false"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="searchcriteria" type="text"
                                                                    class="form-control" id="searchcriteria" size="40"
                                                                    isdatepicker="true">
                                                            </td>
                                                        </tr>
                                                    </tbody>
            ...
            <footer class="footer_area section_padding_130_0 " style="margin-top: 30px;">
                <div class="container">
                    <div class="row">
                        <!-- Single Widget-->
